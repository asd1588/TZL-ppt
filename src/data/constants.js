 ...
 */
 ...
 export const WORKS = [
  ...
  {themeId:"folder-cover",tag:"封面主题",title:"TZL PPT 品牌形象册",desc:"8页 / 品牌形象",color:"#fce4b8",cover:"linear-gradient(135deg,#fce4b8,#e8c88a)"},
  {themeId:"folder-showcase",tag:"项目展示",title:"TZL 项目优势说明书",desc:"10页 / 项目优势",color:"#f5d78e",cover:"linear-gradient(135deg,#1a1a1a,#c9a84c)"},
  {themeId:"folder-creative",tag:"灵感创意",title:"2026 演示设计灵感趋势",desc:"8页 / 灵感趋势",color:"#edc56a",cover:"linear-gradient(135deg,#2a1035,#e060d0)"},
  {themeId:"folder-works",tag:"设计成果",title:"精选设计作品集",desc:"8页 / 作品案例",color:"#e4b548",cover:"linear-gradient(135deg,#0d2137,#5c7d9c)"}
];
...
export const WORK_TYPES = [
 ...
 /** PPT 主题风格（取自 Dashi PPT 16 套内置主题） */
 export const THEMES = [
