...
list.forEach(function(p){
  ...
  var s2 = h.lastIndexOf("<script>\nfetch");
  var e2 = h.indexOf("</script>", s2) + 9;
  h = h.substring(0, s2) + script + h.substring(e2);
